...
import {TransparentUpgradeableProxy, ITransparentUpgradeableProxy as IProxy} from "@openzeppelin/contracts-v4.9.0/proxy/transparent/TransparentUpgradeableProxy.sol";
...
address payable constant VAULT_PROXY = payable(
...
contract ForkTest is Test {
    ...
    function setUp() public {
        ...
        assertEq(vault.depositLimit(), 1_472_000 ether); // Note that this value might change
    ...
    function test_UserReceivesSLYXAndBurnThemToConvertToStake() public {
        ...
        assertEq(vault.balanceOf(alice), expectedLYXStake - 3 wei); // not clear why there are 3 wei difference
